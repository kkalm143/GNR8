...
export function EditAccountForm({ initial, className, backHref = "/dashboard", backLabel = "Back to dashboard" }: Props) {
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            readOnly
            disabled
            className="w-full rounded-md border border-zinc-300 bg-zinc-100 px-3 py-2 text-zinc-500 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-400"
          />
          <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
            Contact your coach to change your login email.
          </p>
        </div>
        <div>
          <label className="mb-1 block text-sm font-medium text-zinc-700 dark:text-zinc-300">
